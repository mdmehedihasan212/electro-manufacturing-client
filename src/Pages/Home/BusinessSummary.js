        ...
        <div className='my-12'>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-6 w-full mx-auto mt-12">
                ...
                <div class="items-center text-center">
                    ...
                    <div>Customers</div>
                    <div class="text-5xl lg:text-6xl font-bold">100+</div>
                ...
                <div class="items-center text-center">
                    ...
                    <div class="text-5xl lg:text-6xl font-bold">120M+</div>
                    <div>Jan 1st - May 1st</div>
                </div>
                ...
                <div class="items-center text-center">
                    ...
                    <div> Reviews</div>
                    <div class="text-5xl lg:text-6xl font-bold">33K</div>
                    <div>Jan 1st - May 1st</div>
                </div>
                ...
                <div class="items-center text-center">
                    ...
                    <div>Tools</div>
                    <div class="text-5xl lg:text-6xl font-bold">50+</div>
                    <div>Jan 1st - May 1st</div>
                </div>
