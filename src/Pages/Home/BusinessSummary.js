...
const BusinessSummary = () => {
    return (
        <div className='my-12'>
            <h1 className='text-4xl text-center text-primary'>Business Summary</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-6 w-full mx-auto my-12">
