...
const Blogs = () => {
    ...
    return (
        <div>
            ...
            <div>
                <h1 className='text-2xl'>What is a unit test?</h1>
                <p>This is a type of testing which is done by software developers in which the smallest testable module of an application - like functions, procedures or interfaces</p>
                <h1 className="text-2xl">Why should write unit tests?</h1>
                <p>Unit tests are also especially useful when it comes to refactoring or re-writing a piece a code. If you have good unit tests coverage, you can refactor with confidence. Without unit tests, it is often hard to ensure the you didn't break anything</p>
            </div>
        </div>
    );
};
